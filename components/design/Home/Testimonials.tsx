				...
				<Tabs.Root defaultValue="tab-one">
					...
					<Tabs.Content value="tab-one">
						<article className="mx-auto grid grid-cols-[1fr,5fr,1fr] items-center py-2 text-cimi-cream">
							<ChevronLeftIcon className="mr-3 ml-auto h-8 w-8 cursor-pointer text-cimi-cream" />
							...
							<ChevronRightIcon className="mr-auto ml-3 h-8 w-8 cursor-pointer text-cimi-cream" />
						</article>
					</Tabs.Content>
