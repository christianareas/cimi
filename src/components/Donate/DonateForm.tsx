				...
				<Form.Root>
					...
					<Form.Field name="donation-amounts">
						...
						<section className="text-center">
							...
							>
								<p className="pb-3 text-red-500 text-xs italic">
									Enter an amount with no more than 2 decimal places (for
									example, 100.00).
								</p>
							</Form.Message>
							<Form.Message
					...
					<section className="flex justify-end">
						<Form.Submit asChild>
							<button
								type="button"
								className={`w-32 cursor-pointer rounded-lg border-2 px-4 py-3 text-center font-ancho font-medium text-xs shadow-[4px_4px_0] ${colorsSchemes["cimi-green-dark"]}`}
							>
								Continue
							</button>
						</Form.Submit>
