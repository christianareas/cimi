	...
	join: {
		buttons: {
			...
			"4-collapsible-content":
				"We gladly welcome any individual interested in sharing their expertise and knowledge in topics like computer literacy, coding, engineering, and more! Send us an email at [info@runwithcimi.org](#) to get the conversation started. \n",
			"5-button-text":
				"I want to **tutor** elementary, middle, or high school students in CIMI.\n",
			"5-collapsible-content":
				"CIMI is happy to connect children and young adults with mentors to further their educational journey. Send us an email at [info@runwithcimi.org](#) to see how you can help! \n",
			"6-button-text": "I want to become a **corporate sponsor** of CIMI.\n",
			"6-collapsible-content":
				"CIMI deeply values the opportunities that corporate sponsorships can bring to its members and the community. Send us an email at [info@runwithcimi.org](#) to see how we can work together! \n",
			"7-button-text":
				"I want to **participate in Adopt-a-Family** to provide essentials for families in need.\n",
			"7-collapsible-content":
				"Your generosity will make sure families can celebrate the holiday season with comfort and joy. Find out how you can get involved by sending us an email at [info@runwithcimi.org](#).\n",
			"8-button-text":
